...
//class GazeTracking{
//public:
//	/*static GazeTracking* getInstance()
//	{
//		if(instance == NULL)
//			instance = new GazeTracking();
//		return instance;
//	}*/
//	GazeTracking();
//
//	~GazeTracking();
//
//	bool initialize(cv::String xmlFile = "res/haarcascade_eye_tree_eyeglasses.xml");
//
...
public:
	...
	cv::Point getLeftPupil();
	cv::Point getRightPupil();
	cv::Point getLeftPupilInImage();
	cv::Point getRightPupilInImage();

	void getLeftPupilXY(int& x, int& y);
	void getRightPupilXY(int& x, int& y);
	void getLeftPupilXYInImage(int& x, int& y);
	void getRightPupilXYInImage(int& x, int& y);
